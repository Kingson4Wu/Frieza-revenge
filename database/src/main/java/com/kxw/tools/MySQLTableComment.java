...
public class MySQLTableComment {
    ...
    public static Map<String,String> commentMap2 = new HashMap<>();


    public static Connection getMySQLConnection() throws Exception {
        Class.forName("com.mysql.jdbc.Driver");
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/bigdoctor", "root", "123456");
        return conn;
    }
...
//              System.out.println("字段名称：" + rs.getString("Field") + "\t"+ "字段注释：" + rs.getString("Comment") );
                ...
                commentMap2.put(KotlinEntityUtils.fuck2(rs.getString("Field")),rs.getString("Comment"));
            }
//          }
            rs.close();
        }
...
//      return map;
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map tablesComment = getCommentByTableName(Arrays.asList("treatment_record"));
        ...
        getColumnCommentByTableName(Arrays.asList("treatment_record"));
    }
}