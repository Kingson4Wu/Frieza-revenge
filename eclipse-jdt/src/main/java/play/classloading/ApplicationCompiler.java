...
/*if("1.5".equals(Play.configuration.get("java.source"))) {
            ...
            javaVersion = CompilerOptions.VERSON_1_7;
        }*//*

        if("1.5".equals(javaSource)) {
            javaVersion = CompilerOptions.VERSION_1_5;
        } else if("1.6".equals(javaSource)) {
            javaVersion = CompilerOptions.VERSION_1_6;
        } else if("1.7".equals(javaSource)) {
            javaVersion = CompilerOptions.VERSION_1_7;
        }
        ...
        ICompilerRequestor compilerRequestor = new ICompilerRequestor() {
            ...
            public void acceptResult(CompilationResult result) {
                ...
                for (int i = 0; i < clazzFiles.length; i++) {
                    ...
                    ApplicationClass appClass = applicationClasses.getApplicationClass(clazzName.toString());
                    if (appClass == null) {
                        String error = "can not compile class :" + clazzName.toString();
                        Logger.error(error);
