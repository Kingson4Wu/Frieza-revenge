package com.kxw.encryption.paillier;
 ...
 *    URL: <a href="http://www.gemplus.com/smart/rd/publications/pdf/Pai99pai.pdf">http://www.gemplus
 *    .com/smart/rd/publications/pdf/Pai99pai.pdf</a><br>
 *
 * [2] Paillier cryptosystem from Wikipedia.
 *    URL: <a href="http://en.wikipedia.org/wiki/Paillier_cryptosystem">http://en.wikipedia
 *    .org/wiki/Paillier_cryptosystem</a>
...
public class Paillier {
     ...
     * @param certainty The probability that the new BigInteger represents a prime number will exceed (1 - 2^
     *                  (-certainty)). The execution time of this constructor is proportional to the value of this
     *                  parameter.
     */
    ...
    /**
     * Constructs an instance of the Paillier cryptosystem with 512 bits of modulus and at least 1-2^(-64) certainty
     * of primes generation.
     */
    public Paillier() {
    ...
    public void KeyGeneration(int bitLengthVal, int certainty) {
        ...
        /*Constructs two randomly generated positive BigIntegers that are probably prime, with the specified
    ...
    /**
     * Encrypts plaintext m. ciphertext c = g^m * r^n mod n^2. This function explicitly requires random input r to
    ...
    /**
     * Encrypts plaintext m. ciphertext c = g^m * r^n mod n^2. This function automatically generates random input r
