...
/**
 * <a href='http://www.ibm.com/developerworks/cn/java/j-jvmc5/index.html'>@link</a>
 */
public class Hello3 {
    ...
    private static class Greeter extends AbstractActor {
        ...
        Greeter(String name, String greeting) {
            ...
            receive(ReceiveBuilder.
                    ...
                    matchEquals(AskName, a -> Greeter.this.sender().tell(new TellName(myName), Greeter.this.self())).
