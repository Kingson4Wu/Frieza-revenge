...
/**
 *
 * https://www.programcreek.com/java-api-examples/?api=net.sf.cglib.beans.BeanCopier
 *
 * 将beancopier做成静态类，方便拷贝
 * <br>创建日期：2015年12月1日
 * <br><b>Copyright 2015 UTOUU All Rights Reserved</b>
 * http://ysj5125094.iteye.com/blog/2260885
...
public class CglibBeanCopierUtils {
    ...
    public static void main(String[] args) {
        ...
        copyProperties(map, kingson);

        System.out.println(kingson.getName());

        Kingson kingson1 = new Kingson();
        kingson1.setName("3333");
        copyProperties(kingson1, kingson);
        System.out.println(kingson.getName());
    }
}
