...
public class JsFilter {
    ...
    public static void main(String[] args) {
        ...
        String cc = StringEscapeUtils.escapeHtml(str2);
        System.out.println(cc);
        String dd = StringEscapeUtils.unescapeHtml(cc);
